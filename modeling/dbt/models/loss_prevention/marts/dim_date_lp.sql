-- Conformed daily date dimension for the loss_prevention anchor.
-- Suffix `_lp` avoids collision with merchandising / pricing_and_promotions /
-- agentic_commerce / other anchor dim_date tables.
{{ config(materialized='table') }}

with day_seq as (
    {{ dbt_utils.date_spine(
        datepart="day",
        start_date="cast('2025-05-01' as date)",

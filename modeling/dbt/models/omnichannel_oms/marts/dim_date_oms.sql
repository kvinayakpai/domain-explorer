-- Conformed daily date dimension for the omnichannel_oms anchor.
-- Suffix `_oms` avoids collision with merchandising / pricing_and_promotions /
-- agentic_commerce / trade_promotion_management date dimensions.

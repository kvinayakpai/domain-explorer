 ...
 * `getRowObjectsJson` stringifies bigints / decimals so they survive serialization
 * across Server Components — we coerce numeric strings back where needed in the
 * snapshot helpers.
 */
